...
//       WidgetsBinding.instance.addPostFrameCallback((_) {
//         _scrollToActiveLyric(newActiveIndex);
//       });
//     }
//   }
//
...
//       ),
//       body: widget.trackData.syncedLyrics == null || parsedLrc.lyrics.isEmpty
//           ? const Center(child: Text('Synced Lyrics not available!',style: TextStyle(fontSize: 20),),)
//           : Column(
//         children: [
//           Padding(
//             padding: const EdgeInsets.all(8.0),
...
//                   isActive = currentTime >= lyric.timestamp.inSeconds &&
//                       currentTime <
//                           parsedLrc.lyrics[index + 1].timestamp.inSeconds;
//                 } else {
//                   isActive = currentTime >= lyric.timestamp.inSeconds;
//                 }
//                 return ListTile(
